...
Robot.prototype.onStep = function() {
  ...
  {
    if(this == robots[i]) continue;
    var distance = this.root.position.distanceTo(robots[i].root.position);
  ...
  this.root.translateZ(5);//local coordinate system
