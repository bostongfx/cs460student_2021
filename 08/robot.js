...
Robot.prototype.onStep = function() {
  ...
  //
  if(this.root.position.z > 487) {
    this.root.rotateY(180);
  }
  else if(this.root.position.z < -487) {
    this.root.rotateY(180);
  }
  else if(this.root.position.x > 487) {
    this.root.rotateY(180);
  }
  else if(this.root.position.x < -487) {
    this.root.rotateY(180);
  ...
  for ( var r in all_robots ){
    r = all_robots[r];
    if (this.root != r.root && this.root.position.distanceTo(r.root.position) < 50){
      this.root.rotateY(180);
    }
  }
